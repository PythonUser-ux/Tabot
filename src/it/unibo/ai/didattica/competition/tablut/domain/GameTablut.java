...
public class GameTablut implements Game {
	 ...
	 */
	public State Move(State state, Action a) throws BoardException, ActionException, StopException, PawnException, DiagonalException, ClimbingException, ThroneException, OccupitedException
	{
	...
	public State checkMove(State state, Action a) throws BoardException, ActionException, StopException, PawnException, DiagonalException, ClimbingException, ThroneException, OccupitedException
	{
		...
		//se sono arrivato qui la mossa è valida
		
		//if(true){System.out.println("Mossa accettata");}
		return state;
	}
